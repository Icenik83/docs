...
WEGABOX это отдельное устройство и элемент экосистемы WEGA, по сбору и управлению параметрами гидропонной установки. В первую очередь он разработан для 
применения с DNFT и NFT системами и позволяет получать и контролировать следующие параметры системы:
1.	Микроклимат:
